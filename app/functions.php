...
{
    if ($value === '' || !preg_match('/Ã.|Â[·ºª°“”‘’…]|ï¿½/u', $value)) {
        return $value;
    }

    $fixed = $value;
    for ($i = 0; $i < 3; $i++) {
        $next = str_replace(['ÃƒÂ', 'Ã‚Â'], ['Ã', 'Â'], $fixed);
        if ($next === $fixed) {
            break;
        }
        $fixed = $next;
    ...
    $replacements = [
        ...
        'Ã' => 'Í', 'ÃŽ' => 'Î', 'Ã' => 'Ï', 'Ã‘' => 'Ñ', 'Ã’' => 'Ò', 'Ã“' => 'Ó',
        'Ã”' => 'Ô', 'Ã•' => 'Õ', 'Ã–' => 'Ö', 'Ã™' => 'Ù', 'Ãš' => 'Ú', 'Ã›' => 'Û',
        'Ãœ' => 'Ü',
        'Ã ' => 'à', 'Ã¡' => 'á', 'Ã¢' => 'â', 'Ã£' => 'ã', 'Ã¤' => 'ä', 'Ã¥' => 'å',
        'Ã§' => 'ç', 'Ã¨' => 'è', 'Ã©' => 'é', 'Ãª' => 'ê', 'Ã«' => 'ë', 'Ã¬' => 'ì',
        'Ã­' => 'í', 'Ã®' => 'î', 'Ã¯' => 'ï', 'Ã±' => 'ñ', 'Ã²' => 'ò', 'Ã³' => 'ó',
        'Ã´' => 'ô', 'Ãµ' => 'õ', 'Ã¶' => 'ö', 'Ã¹' => 'ù', 'Ãº' => 'ú', 'Ã»' => 'û',
        'Ã¼' => 'ü',
        'Âº' => 'º', 'Âª' => 'ª', 'Â°' => '°', 'Â·' => '·', 'Â–' => '–', 'Â—' => '—',
        'Â“' => '“', 'Â”' => '”', 'Â‘' => '‘', 'Â’' => '’', 'Â…' => '…', 'ï¿½' => '',
    ];

    return strtr($fixed, $replacements);
}
