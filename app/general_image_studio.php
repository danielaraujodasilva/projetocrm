...
function studio_tattoo_image_handle_request(): void
{
    ...
    render_studio_shell('Criar imagem', 'Geração livre: diga o que quer ver e a IA tenta seguir literalmente.', 'tattoo_images', function () use ($studio) {
        ...
        echo '<style>.ti-gen{align-items:start!important;grid-template-columns:minmax(300px,420px) minmax(0,1fr)!important;gap:20px!important}.ti-box{border-radius:22px!important;padding:18px!important;border-color:rgba(15,23,42,.08)!important;box-shadow:0 20px 54px rgba(15,23,42,.07)!important}.ti-prompt textarea{min-height:150px!important;border-radius:16px!important}.ti-main-actions .btn{border-radius:14px}.ti-options{border-radius:16px!important;overflow:hidden}.ti-options summary{background:linear-gradient(180deg,#fff,#f8fafc);padding:13px 14px!important}.ti-options-body{grid-template-columns:repeat(2,minmax(0,1fr))!important}.ti-chip{border-color:rgba(15,118,88,.18)!important;background:rgba(15,118,88,.08)!important;color:#0f6f55!important}.ti-result{min-height:unset!important}.ti-result-frame{min-height:360px!important;max-height:min(74vh,780px);border-radius:18px!important;background:linear-gradient(45deg,rgba(15,23,42,.035) 25%,transparent 25%),linear-gradient(-45deg,rgba(15,23,42,.035) 25%,transparent 25%),#f6f7f4!important;background-size:24px 24px!important}.ti-result-frame img{max-height:min(74vh,780px)!important}.ti-meta{border-top:1px solid rgba(15,23,42,.08);padding-top:12px}.ti-history{grid-template-columns:repeat(auto-fill,minmax(150px,1fr))!important}@media(max-width:980px){.ti-gen{grid-template-columns:1fr!important}.ti-options-body{grid-template-columns:1fr!important}}</style>';
