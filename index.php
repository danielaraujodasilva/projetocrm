...
if ($page === 'studio_whatsapp_mobile') {
    ...
    echo '<style>
        ...
        .mobile-wa-menu-panel,.mobile-wa-emoji-panel,.mobile-wa-schedule-panel,.mobile-wa-global-panel{position:fixed;left:12px;right:12px;bottom:84px;z-index:40;background:rgba(17,27,33,.98);backdrop-filter:blur(18px);border:1px solid rgba(255,255,255,.08);border-radius:18px;padding:12px;box-shadow:0 20px 50px rgba(0,0,0,.36);max-height:42vh;overflow:auto}
