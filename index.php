    ...
    render_public_page('Atualizar cadastro', 'Complete seus dados para agilizar o atendimento.', function () use ($lead, $leadId, $token, $customerSeed, $missingFields) {
        ...
        echo '<style>
            ...
            @media (max-width: 900px){
                .public-lead-summary,.public-lead-pill-grid,.public-lead-consent-grid{grid-template-columns:1fr}
        ...
        echo '</div>';
        echo '<div class="public-lead-disclaimer"><div><strong>Antes de começar</strong><span class="muted">Campos grandes, leitura simples e nada competindo com o formulário. Se você não quiser preencher tudo agora, tudo bem.</span></div></div>';
