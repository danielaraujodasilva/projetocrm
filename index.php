...
if ($page === 'studio_home') {
    ...
    render_studio_shell('Inicio do CRM', 'Resumo operacional da instancia ' . (string)$user['studio_name'] . '.', 'home', function () use ($studio, $user) {
        ...
        foreach ([
            ...
            echo '<button type="button" class="panel dashboard-stat dashboard-stat-button" data-home-focus="' . h($stat['focus']) . '"><p class="metric">' . h((string)$stat['value']) . '</p><p class="muted">' . h($stat['label']) . '</p><span class="muted">Ver detalhes</span></button>';
        }
        echo '</section>';
        ...
        foreach ([
            ...
            echo '<button type="button" class="panel dashboard-stat dashboard-stat-button" data-home-focus="' . h($stat['focus']) . '"><p class="metric">' . h((string)$stat['value']) . '</p><p class="muted">' . h($stat['label']) . '</p><span class="muted">Abrir detalhe</span></button>';
        }
        echo '</section>';
