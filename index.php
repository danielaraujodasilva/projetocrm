...
if ($page === 'studio_whatsapp_mobile') {
    ...
    if (!$conversation) {
        ...
        echo '<button class="mobile-wa-icon-btn" type="button" id="mobileRecordAudioButton" aria-label="Audio" onclick="if(window.mobileToggleRecording){window.mobileToggleRecording();}"><i class="fa-solid fa-microphone"></i><span>Áudio</span></button>';
