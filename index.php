...
if ($page === 'studio_home') {
    ...
    render_studio_shell('Inicio do CRM', 'Resumo operacional da instancia ' . (string)$user['studio_name'] . '.', 'home', function () use ($studio, $user) {
        ...
        foreach ([
            ...
            echo '<a class="panel dashboard-stat" href="#" onclick="return window.openHomeDrilldown(\'' . h($stat['focus']) . '\')"><p class="metric">' . h((string)$stat['value']) . '</p><p class="muted">' . h($stat['label']) . '</p><span class="muted">Ver detalhes</span></a>';
        }
        echo '</section>';
        ...
        foreach ([
            ...
            echo '<a class="panel dashboard-stat" href="#" onclick="return window.openHomeDrilldown(\'' . h($stat['focus']) . '\')"><p class="metric">' . h((string)$stat['value']) . '</p><p class="muted">' . h($stat['label']) . '</p><span class="muted">Abrir detalhe</span></a>';
        }
        echo '</section>';
