...
if ($page === 'lead_public_update') {
    ...
    render_public_page('Atualizar cadastro', 'Complete seus dados para agilizar o atendimento.', function () use ($lead, $leadId, $token, $customerSeed, $missingFields) {
        ...
        echo '<style>
            .public-lead-shell{max-width:1120px;margin:0 auto;padding:0 0 20px}
            .public-lead-hero{position:relative;overflow:hidden;border:1px solid rgba(31,111,120,.14);background:linear-gradient(135deg,rgba(17,24,39,.98),rgba(31,111,120,.92));color:#fff;border-radius:18px;padding:24px;box-shadow:0 24px 60px rgba(15,23,42,.18)}
            .public-lead-hero:before{content:"";position:absolute;inset:auto -80px -120px auto;width:280px;height:280px;border-radius:50%;background:radial-gradient(circle,rgba(255,255,255,.22),rgba(255,255,255,0) 70%);pointer-events:none}
            .public-lead-hero h1{margin:10px 0 10px;font-size:clamp(30px,4vw,52px);line-height:1.02;letter-spacing:0}
            .public-lead-hero p{max-width:68ch;line-height:1.7}
            .public-lead-grid{display:grid;grid-template-columns:minmax(0,1.7fr) minmax(280px,.95fr);gap:18px;margin-top:18px;align-items:start}
            .public-lead-stack{display:grid;gap:16px}
            .public-lead-section{border:1px solid rgba(15,23,42,.08);border-radius:18px;background:#fff;padding:18px;box-shadow:0 10px 30px rgba(15,23,42,.05)}
            .public-lead-section h2{margin:0 0 10px;font-size:1.05rem}
            .public-lead-section .field label{font-size:.86rem;color:#334155}
            .public-lead-aside{position:sticky;top:20px}
            .public-lead-summary{display:grid;gap:12px}
            .public-lead-chip{display:flex;justify-content:space-between;align-items:center;gap:12px;border:1px solid rgba(148,163,184,.24);border-radius:14px;padding:12px 14px;background:rgba(248,250,252,.9)}
            .public-lead-chip strong{font-size:1rem}
            .public-lead-note{font-size:.92rem;color:#475569;line-height:1.55;margin:0}
            .public-lead-sticky{position:sticky;top:20px}
            .public-lead-btn-row{display:flex;flex-wrap:wrap;gap:10px}
            .public-lead-kicker{display:inline-flex;align-items:center;gap:8px;padding:6px 10px;border-radius:999px;background:rgba(255,255,255,.14);backdrop-filter:blur(8px);font-size:.85rem}
            ...
            @media (max-width: 900px){
                .public-lead-grid{grid-template-columns:1fr}
                .public-lead-aside,.public-lead-sticky{position:static}
                .public-lead-consent-grid,.public-lead-pill-grid{grid-template-columns:1fr}
            }
        </style>';
        echo '<div class="public-lead-shell">';
        ...
        echo '</section>';
        echo '<div class="public-lead-grid">';
        echo '<div class="public-lead-stack">';
        echo '<div class="public-lead-pill-grid">';
        echo '<div class="public-lead-pill"><strong>1. Básicos</strong><span>Contato e interesse</span></div>';
        echo '<div class="public-lead-pill"><strong>2. Endereço</strong><span>Opcional, mas útil</span></div>';
        echo '<div class="public-lead-pill"><strong>3. Anamnese</strong><span>Cuidados e histórico</span></div>';
        echo '<div class="public-lead-pill"><strong>4. Consentimentos</strong><span>Você escolhe o que autoriza</span></div>';
        echo '</div>';
