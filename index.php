...
if ($page === 'lead_public_update') {
    ...
    render_public_page('Atualizar cadastro', 'Complete seus dados para agilizar o atendimento.', function () use ($lead, $leadId, $token, $customerSeed) {
        ...
        echo '<section class="panel" style="max-width:980px;margin:0 auto;background:linear-gradient(180deg,rgba(31,111,120,0.08),rgba(31,111,120,0.02));border:1px solid rgba(31,111,120,0.14);box-shadow:0 14px 40px rgba(0,0,0,0.08)">';
        echo '<div class="actions" style="justify-content:space-between;align-items:flex-start;gap:16px;flex-wrap:wrap">';
        echo '<div><span class="badge ok">Cadastro rápido</span><h1 style="margin:10px 0 8px">Complete sua ficha</h1><p class="muted" style="max-width:62ch;margin:0">Leva poucos minutos. Quanto mais completo, mais fácil fica organizar seu atendimento, seu histórico e os próximos passos.</p></div>';
        echo '<div class="panel soft" style="min-width:220px"><strong>Você só precisa preencher o que souber</strong><p class="muted" style="margin:6px 0 0">O restante pode ficar em branco e ser ajustado depois pela equipe.</p></div>';
        echo '</div>';
