...
if ($page === 'studio_whatsapp_mobile') {
    ...
    if (!$conversation) {
        ...
        echo '<button class="mobile-wa-icon-btn" type="button" id="mobileOpenEmojiPanel" aria-label="Emoji" title="Emoji"><span aria-hidden="true">☺</span><span>Emoji</span></button>';
        echo '<button class="mobile-wa-icon-btn" type="button" id="mobileOpenAttachmentPicker" aria-label="Anexar" title="Anexar"><span aria-hidden="true">＋</span><span>Anexar</span></button>';
        echo '<button class="mobile-wa-icon-btn" type="button" id="mobileRecordAudioButton" aria-label="Audio" title="Áudio"><span aria-hidden="true">🎤</span><span>Áudio</span></button>';
    ...
    echo '<button type="button" class="mobile-wa-action" id="mobileGlobalRefreshAction"><span aria-hidden="true">↻</span><span>Atualizar lista</span></button>';
    if ($conversationId > 0) {
