...
if ($page === 'studio_whatsapp_mobile') {
    ...
    echo '<style>
        ...
        .mobile-wa-shell input,.mobile-wa-shell textarea,.mobile-wa-shell select{font-size:16px !important}
    ...
    if (!$conversation) {
        ...
        echo '<input type="file" id="mobileAudioInput" name="media_file_audio" accept="audio/*" capture="microphone" hidden>';
        ...
        echo '<button class="mobile-wa-icon-btn" type="button" id="mobileRecordAudioButton" aria-label="Audio" onclick="var p=document.getElementById(\'mobileAudioInput\'); if(p){p.click();}"><i class="fa-solid fa-microphone"></i><span>Áudio</span></button>';
